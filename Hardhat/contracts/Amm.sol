...
contract AMM {
    ...
    function provide(uint256 _amountMatic, uint256 _amountGoflow)
        external
    ...
    function getMyHoldings(address user)
        external
        view
        returns (
            uint256 maticAmount,
    ...
    function getEquivalentMaticEstimate(uint256 _amountGoflow)
        public
        view
        activePool
        returns (uint256 reqMatic)
    {
    ...
    function getEquivalentGoflowEstimate(uint256 _amountMatic)
        public
        view
        activePool
        returns (uint256 reqGoflow)
    {
